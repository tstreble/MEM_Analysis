...
void plot_Deta(bool plot_log=false){
  ...
  h.push_back(single_plot("/home/llr/cms/mastrolorenzo/CMS-MEM-GSL-MachineMPI_5D/CMS-MEM/nTuple_Htautau_withMEM/nTupleVBFH125_MuTau_nominal.root","T","Deta", weight_VBF+" * ("+cut_VBF+")",75,0,7.5)); 
  h.push_back(single_plot("/home/llr/cms/mastrolorenzo/CMS-MEM-GSL-MachineMPI_5D/CMS-MEM/nTuple_Htautau_withMEM/nTupleRun2012ABCD_Embedded8TeV.root","T","Deta", weight_DY+" * ("+cut_DY+")",75,0,7.5)); 
  ...
  h[0]->GetXaxis()->SetTitle("#Delta#eta");
  ...
  h[0]->SetTitle("#Delta#eta distribution");
