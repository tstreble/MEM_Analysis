...
void plot_Mjj(bool plot_log=false){
  ...
  h.push_back(single_plot("/home/llr/cms/mastrolorenzo/CMS-MEM-GSL-MachineMPI_5D/CMS-MEM/nTuple_Htautau_withMEM/nTupleVBFH125_MuTau_nominal.root","T","Mjj", weight_VBF+" * ("+cut_VBF+")",50,0,2000)); 
  h.push_back(single_plot("/home/llr/cms/mastrolorenzo/CMS-MEM-GSL-MachineMPI_5D/CMS-MEM/nTuple_Htautau_withMEM/nTupleRun2012ABCD_Embedded8TeV.root","T","Mjj", weight_DY+" * ("+cut_DY+")",50,0,2000)); 
  ...
  h[0]->GetXaxis()->SetTitle("M_{jj} [GeV]");
  ...
  h[0]->SetTitle("M_{jj} distribution");
