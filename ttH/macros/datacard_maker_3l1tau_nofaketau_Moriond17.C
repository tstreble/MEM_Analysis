 ...
 TString var = var1 + "*(" + var1 + Form("<=%f) + %f*(",xmax,0.999*xmax) + var1 + Form(">%f)",xmax);
  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    TH1F* h_data_obs =single_plot(filename_data,
				  "HTauTauTree_3l",
				  var,
				  Form("(category==%i && isTrig_3l_v2)",cat[i_cat]),		
				  nbin,xmin,xmax);
...
void datacard_maker_MVA_3l_ttbar(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_12_2016/datacards/datacard_MVA_3l_ttbar_nofaketau_36.8fb.root";
...
void datacard_maker_MVA_3l_ttV(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_12_2016/datacards/datacard_MVA_3l_ttV_nofaketau_36.8fb.root";
