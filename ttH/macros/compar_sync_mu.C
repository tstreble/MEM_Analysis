...
void compar_EventNumber_mu(){
  ...
  tree->Draw("EventNumber>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",0,500000,0,500000);
  ...
  TString plotname="sync/EventNumber_mu_IPHC";
...
void compar_pt_mu(){
  ...
  tree->Draw("recomu_pt[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",1,100,0,500);
  ...
  for(unsigned int i=0; i<5000000;i++){
    ...
    int IPHC = h_sync->GetBinContent(i);
    if(LLR!=IPHC){
      cout<<"i="<<i<<endl;
      cout<<"LLR="<<LLR<<endl;
      cout<<"IPHC="<<IPHC<<endl;
  ...
  TString plotname="sync/pt_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_eta_mu(){
  ...
  tree->Draw("recomu_eta[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",2,75,-3,3);
  ...
  TString plotname="sync/eta_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_phi_mu(){
  ...
  tree->Draw("recomu_phi[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",3,80,-3.2,3.2);
  ...
  TString plotname="sync/phi_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_E_mu(){
  ...
  TH1F* h = new TH1F("h","h",100,0,500);
  tree->Draw("recomu_e[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",4,100,0,500);
  ...
  TString plotname="sync/E_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_charge_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",5,-2,3);
  tree->Draw("recomu_charge[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",6,5,-2,3);
  ...
  TString plotname="sync/charge_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_miniRelIso_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",50,0,0.4);
  tree->Draw("recomu_miniRelIso[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_CERN_mu.txt",7,50,0,0.4);
  ...
  TString plotname="sync/miniRelIso_mu_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_miniIsoCharged_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",50,0,5);
  tree->Draw("recomu_miniIsoCharged[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_CERN_mu.txt",8,50,0,5);
  ...
  TString plotname="sync/miniIsoCharged_mu_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_miniIsoNeutral_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",50,0,5);
  tree->Draw("recomu_miniIsoNeutral[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_CERN_mu.txt",9,50,0,5);
  ...
  TString plotname="sync/miniIsoNeutral_mu_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_jetPtRel_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",50,0,100);
  tree->Draw("recomu_jetPtRel[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_CERN_mu.txt",10,50,0,100);
  ...
  TString plotname="sync/jetPtRel_mu_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_jetCSV_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",51,0.,1.);
  tree->Draw("recomu_jetCSV[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_CERN_mu.txt",11,51,0.,1.);
  ...
  TString plotname="sync/jetCSV_mu_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_jetPtRatio_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",75,0.,1.5);
  tree->Draw("recomu_jetPtRatio[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_CERN_mu.txt",12,75,0.,1.5);
  ...
  TString plotname="sync/jetPtRatio_mu_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_jetPtRatio_mu_backup(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_backup_iso25.root");
  ...
  TString plotname="sync/jetPtRatio_mu_backup_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_sip3D_mu(){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/home/llr/cms/strebler/CMSSW_7_4_12_leptonMVA/src/LLRHiggsTauTau/NtupleProducer/test/syncNtuple_ttH_iso25.root");

  TH1F* h = new TH1F("h","h",80,0.,8.);
  tree->Draw("recomu_sip3D[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",13,80,0.,8.);
  ...
  TString plotname="sync/SIP3D_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_dxy_mu(){
  ...
  tree->Draw("abs(recomu_dxy[0])>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",14,21,0.,0.02);
  ...
  TString plotname="sync/dxy_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_dz_mu(){
  ...
  tree->Draw("recomu_dz[0]>>h","n_recomu>=1","goff");

  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",15,51,-0.05,0.05);
  ...
  TString plotname="sync/dz_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_segm_compat_mu(){
  ...
  TH1F* h_sync = histo_fromlog("log_IPHC_mu.txt",16,56,0.,1.1);
  ...
  TString plotname="sync/segm_compat_mu_IPHC";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
/*void compar_lepMVA_mu(){
  ...
  tree->Draw("recomu_leptonMVA>>h","n_recomu>=1","goff");
  ...
  TString plotname="sync/lepMVA_mu";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_lepMVA_mu(){
  ...
  TH1F* h = histo_fromlog("mu.txt",18,120,-1.1,1.1);

  vector<TH1F*> h_sync;
  h_sync.push_back(histo_fromlog("log_CERN_mu.txt",18,120,-1.1,1.1));
  h_sync.push_back(histo_fromlog("log_IPHC_mu.txt",18,120,-1.1,1.1));
  ...
  TString plotname="sync/mu_lepMVA_IPHC_CERN";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
