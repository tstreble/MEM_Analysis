...
void plot_deltapT_nodRveto(){
  ...
  TString filename="jet_bigauss_deltapT_barrel_nodRveto";
...
void plot_mean_sigma_jetTF(){
  ...
  TString filename0="frac_jetTF_bigauss_pT";
  ...
  TString filename="mean_jetTF_bigauss_pT";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
  ...
  TString filename2="sigma_jetTF_bigauss_pT";
  c2->SaveAs("../plots/pdf/"+filename2+".pdf");
  c2->SaveAs("../plots/png/"+filename2+".png");


  TFile* f_new = TFile::Open("jetTF_bigauss_pT_TTjets.root","RECREATE");
...
void plot_mean_sigma_jetTF_fixfrac(){
  ...
  TString filename="mean_jetTF_bigauss_pT_fixfrac";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
  ...
  TString filename2="sigma_jetTF_bigauss_pT_fixfrac";
  c2->SaveAs("../plots/pdf/"+filename2+".pdf");
  c2->SaveAs("../plots/png/"+filename2+".png");


  TFile* f_new = TFile::Open("jetTF_bigauss_pT_fixfrac_TTjets.root","RECREATE");
  frac_nodRveto->SetName("frac_nodRveto");
  frac_nodRveto->Write();
  mean1_nodRveto->SetName("mean1_nodRveto");
  mean1_nodRveto->Write();
...
void plot_frac_fit(){
  ...
  TFile* f = TFile::Open("jetTF_bigauss_pT_TTjets.root");
  TGraphErrors* frac_nodRveto = (TGraphErrors*)f->Get("frac_nodRveto");

  TF1* new_TF_frac=new TF1("frac", "[0]",50,250);
  ...
  TString filename="frac_jetTF_bigauss_pT_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_mean_fit(){
  ...
  TFile* f = TFile::Open("jetTF_bigauss_pT_fixfrac_TTjets.root");
  ...
  TString filename="mean_jetTF_bigauss_pT_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_sigma_fit(){
  ...
  new_TF_sigma1->SetParLimits(1,0,100);
  new_TF_sigma1->SetParLimits(2,0,100);
  ...
  TString filename="sigma_jetTF_bigauss_pT_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
