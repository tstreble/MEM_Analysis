  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
	...
	h_MC_ext->Write();
      ...
      TH1F* h_MC_genmatch = single_plot(filename_lepMVA_CR_MC[i_MC],
					"T",
					var,
					Form("MC_weight*PU_weight_MCSummer2016*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight_v2*event_weight_ttH_v2*tauSF_weight_v2*(category==%i && isTrig_v2 && recolep_sel_isGenMatched[0] && recolep_sel_isGenMatched[1] && ",cat_fakes[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat + ")",
				    nbin,xmin,xmax);
    ...
    TH1F* h_fakes =single_plot(filename_data_lepMVA_CR,
			       "T",
			       var,			     
			       Form("event_weight_ttH_v2*(category==%i && isTrig_v2 && NBadMu==0 &&",cat_fakes[i_cat]) + cut_cat + ")",
			       nbin,xmin,xmax);

    cout<<"h_fakes:"<<h_fakes->Integral()<<endl;
    ...
    TH1F* h_ttbar_DL_fakes_MC =single_plot(filename_ttbar_DL,
				  "T",
				  var,
				  Form("MC_weight*PU_weight_MCSummer2016*triggerSF_weight_v2*bTagSF_CSVshape_weight_v2*leptonSF_ttH_weight_v2*tauSF_weight_v2*event_weight_ttH_v2*(category==%i && isTrig_v2 && ",cat_fakes[i_cat]) + cut_cat + ")",
				  nbin,xmin,xmax);
    ...
    h_data_obs->Write();
   cout<<Form("(category==%i && isTrig_v2 && ",cat[i_cat]) +  cut_cat + ")"<<endl;
...
void datacard_maker_MEM_2lSS_int_type(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_01_2017/datacards/datacard_MEM_int_type_2lSS_SStau_CR_35.9fb_012017.root";
...
void datacard_maker_MVA_2lSS_syst(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_01_2017/datacards/datacard_MVA_2lSS_SStau_CR_35.9fb_012017.root";
...
void datacard_maker_MEM_2lSS_nomiss_missing_syst(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_01_2017/datacards/datacard_MEM_ttH_vs_full_bkg_2lSS_nomiss_missing_SS_tau_CR_35.9fb_012017.root";
...
void datacard_maker_n_recotauh(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_01_2017/datacards/datacard_n_recotauh_2lSS_SStau_CR_faketau_syst_35.9fb_022017.root";
