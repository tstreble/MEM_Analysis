...
void create_syncNtuple(){
  ...
  TString dir_in="/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/MiniAODv2_prod_02_2016/";
  TString dir_out="/data_CMS/cms/strebler/ttH_Samples/syncNtuples/MiniAODv2_prod_02_2016/";
  TString file="syncNtuple.root";    

  vector<TString> list;
  list.push_back(dir_in+"syncNtuple_ttH.root");
  ...
  float _mu1_E;
  float _mu1_charge;
  float _mu1_jetNDauChargedMVASel;
  ...
  float _ele0_E;
  float _ele0_charge;
  float _ele0_jetNDauChargedMVASel;
  ...
  float _ele1_E;
  float _ele1_charge;
  float _ele1_jetNDauChargedMVASel;
  ...
  tree_new->Branch("tau1_byLooseCombinedIsolationDeltaBetaCorr3Hits",   &_tau1_byLooseCombinedIsolationDeltaBetaCorr3Hits,   "tau1_byLooseCombinedIsolationDeltaBetaCorr3HitsdR03/I");
  tree_new->Branch("tau1_byMediumCombinedIsolationDeltaBetaCorr3Hits",  &_tau1_byMediumCombinedIsolationDeltaBetaCorr3Hits,  "tau1_byMediumCombinedIsolationDeltaBetaCorr3HitsdR03/I");
  tree_new->Branch("tau1_byTightCombinedIsolationDeltaBetaCorr3Hits",   &_tau1_byTightCombinedIsolationDeltaBetaCorr3Hits,   "tau1_byTightCombinedIsolationDeltaBetaCorr3HitsdR03/I");
  ...
  tree->SetBranchAddress("n_recomu",&_n_presel_mu);
  tree->SetBranchAddress("n_recoele",&_n_presel_ele);
