...
void plot_ttH_cat(TString cat){
  ...
  TString file_LLR="/data_CMS/cms/strebler/ttH_prod_80X_06_2016/datacards/datacard_MVA_2lSS_allcat.root";
  ...
  TFile* f_LLR = TFile::Open(file_LLR);
  TH1F* h_LLR = (TH1F*)f_LLR->Get(cat+"/h_ttH");
  h_LLR->SetDirectory(0);
  f_LLR->Close();
  h_LLR->SetLineColor(1);
  h_LLR->SetLineWidth(2);
  ...
  TString filename="MVA_2lSS_ttH_ttbar_datacard_comparison_ttH_cat_"+cat;
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_ttH_all_cat(){


  plot_ttH_cat("ttH_2lss_1tau");
  plot_ttH_cat("ttH_2lss_ee_0tau_neg");
  plot_ttH_cat("ttH_2lss_ee_0tau_pos");
  plot_ttH_cat("ttH_2lss_em_0tau_bl_neg");
  plot_ttH_cat("ttH_2lss_em_0tau_bl_pos");
  plot_ttH_cat("ttH_2lss_em_0tau_bt_neg");
  plot_ttH_cat("ttH_2lss_em_0tau_bt_pos");
  plot_ttH_cat("ttH_2lss_mm_0tau_bl_neg");
  plot_ttH_cat("ttH_2lss_mm_0tau_bl_pos");
  plot_ttH_cat("ttH_2lss_mm_0tau_bt_neg");
  plot_ttH_cat("ttH_2lss_mm_0tau_bt_pos");
