...
void plot_deltapT_nodRveto(){
  ...
  leg->SetHeader(Form("#splitline{p_{T}(reco)>30 GeV, |#eta(reco)|<1.5}{f(#Deltap_{T})=%.2fG_{1}+%.2fG_{2}}",f->GetParameter(0),1-f->GetParameter(0)));
  leg->Draw("same");


  TString filename="bjet_bigauss_deltapT_barrel_nodRveto";
...
void plot_pT_bin_nodRveto(bool low_pT){
  ...
  TString filename="bjet_bigauss_pTbin_barrel_nodRveto";
  if(low_pT)
    filename+="_low_pT";
  else
    filename+="_high_pT";
...
void plot_mean_sigma_jetTF(){
  ...
  TString filename0="frac_bjetTF_bigauss_pT";
  ...
  TString filename="mean_bjetTF_bigauss_pT";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
  ...
  TString filename2="sigma_bjetTF_bigauss_pT";
  c2->SaveAs("../plots/pdf/"+filename2+".pdf");
  c2->SaveAs("../plots/png/"+filename2+".png");


  TFile* f_new = TFile::Open("bjetTF_bigauss_pT_TTjets.root","RECREATE");
...
void plot_mean_sigma_jetTF_fixfrac(){
  ...
  TString filename="mean_bjetTF_bigauss_pT_fixfrac";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
  ...
  TString filename2="sigma_bjetTF_bigauss_pT_fixfrac";
  c2->SaveAs("../plots/pdf/"+filename2+".pdf");
  c2->SaveAs("../plots/png/"+filename2+".png");


  TFile* f_new = TFile::Open("bjetTF_bigauss_pT_fixfrac_TTjets.root","RECREATE");
  frac_nodRveto->SetName("frac_nodRveto");
  frac_nodRveto->Write();
  mean1_nodRveto->SetName("mean1_nodRveto");
  mean1_nodRveto->Write();
...
void plot_mean_fit(){
  ...
  TFile* f = TFile::Open("bjetTF_bigauss_pT_fixfrac_TTjets.root");
  ...
  new_TF_mean2->SetParameter(0,20);
  ...
  TString filename="mean_bjetTF_bigauss_pT_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_sigma_fit(){
  ...
  TLegend* leg=new TLegend(0.2,0.62,0.5,0.87);
  leg->SetBorderSize(0);
  leg->SetTextSize(0.035);
  leg->SetFillColor(0);
  ...
  TString filename="sigma_bjetTF_bigauss_pT_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
