...
float luminosity = 36814; //12.9 fb-1

float XS_ttbar_DL = 87.3;

TString filename_ttbar_DL = "/data_CMS/cms/strebler/ttH_prod_80X_12_2016/ntuples_splitted/nominal/TTbar/HTauTauTree_ttbar_DL_split_PU.root";
...
void write_2lSS(){
  ...
  TString file = "Closure_FR_lepton_syst_2lSS1tau_nofaketau_MVA_2lSS_36.8fb.root";
...
void write_3l(){
  ...
  TString file = "Closure_FR_lepton_syst_3l1tau_nofaketau_MVA_3l_36.8fb.root";
