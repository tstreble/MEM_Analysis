...
void plot_pT_lead_lep(){
  ...
  vector<TH1F*> h;
  h.push_back(single_plot("/data_CMS/cms/strebler/ttH_prod_80X_11_2016/ntuples_splitted/nominal/ttV/HTauTauTree_ttW_ext_split.root","HTauTauTree_2lSS","recolep_sel_pt[0]","MC_weight*(category==11 && !recotauh_sel_isGenMatched[0] && recolep_sel_isGenMatched[0] && recolep_sel_isGenMatched[1])",20,0.,200));
  h.push_back(single_plot("/data_CMS/cms/strebler/ttH_prod_80X_11_2016/ntuples_splitted/nominal/ttV/HTauTauTree_ttW_ext_split.root","HTauTauTree_2lSS_lepMVA_CR","recolep_sel_pt[0]","MC_weight*event_weight_ttH*(category==41 && n_fake_lep==0)",20,0.,200));
  ...
  TLatex *texl = new TLatex(h[0]->GetBinLowEdge(1),1.01*h[0]->GetMaximum(),"CMS Preliminary, Simulation t#bar{t}W #sqrt{s}=13 TeV");
  ...
  TString plotname="lead_lep_pT_fake_extrap_ttW";
...
void plot_pT_lead_jet(){
  ...
  vector<TH1F*> h;
  h.push_back(single_plot("/data_CMS/cms/strebler/ttH_prod_80X_11_2016/ntuples_splitted/nominal/ttV/HTauTauTree_ttW_ext_split.root","HTauTauTree_2lSS","recoPFJet_pt[0]","MC_weight*(category==11 && !recotauh_sel_isGenMatched[0] && recolep_sel_isGenMatched[0] && recolep_sel_isGenMatched[1])",20,0.,400));
  h.push_back(single_plot("/data_CMS/cms/strebler/ttH_prod_80X_11_2016/ntuples_splitted/nominal/ttV/HTauTauTree_ttW_ext_split.root","HTauTauTree_2lSS_lepMVA_CR","recoPFJet_pt[0]","MC_weight*event_weight_ttH*(category==41 && n_fake_lep==0)",20,0.,400));
  ...
  TString plotname="lead_jet_pT_fake_extrap_ttW";
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
