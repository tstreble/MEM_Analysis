...
float luminosity = 12900; //12.900 fb-1
  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC = single_plot(filename_MC[i_MC],
			       "HTauTauTree_1l_2tau",
			       var,
			       Form("MC_weight*PU_weight_MCSummer2016*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(category==%i && isTrig_1l &&",cat[i_cat]) + MC_sample_cut[i_MC] + ")",
			       nbin,xmin,xmax);
	...
	TString cut = "MC_weight*PU_weight_MCSummer2016*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight_" + bTag_syst_names[i_b];
	...
	h_name_TTZ = "x_TTZ_CMS_ttHt_btag_cErr2";
      ...
      TString h_name_WWW = "x_WWW_CMS_ttHt_btag_"+bTag_syst_names[i_b];
      if(bTag_syst_names[i_b]=="CFErr1")
	h_name_WWW = "x_WWW_CMS_ttHt_btag_cErr1";
      else if(bTag_syst_names[i_b]=="CFErr2")
	h_name_WWW = "x_WWW_CMS_ttHt_btag_cErr2";

      TString h_name_WWZ = "x_WWZ_CMS_ttHt_btag_"+bTag_syst_names[i_b];
      if(bTag_syst_names[i_b]=="CFErr1")
	h_name_WWZ = "x_WWZ_CMS_ttHt_btag_cErr1";
      else if(bTag_syst_names[i_b]=="CFErr2")
	h_name_WWZ = "x_WWZ_CMS_ttHt_btag_cErr2";

      TString h_name_WZZ = "x_WZZ_CMS_ttHt_btag_"+bTag_syst_names[i_b];
      if(bTag_syst_names[i_b]=="CFErr1")
	h_name_WZZ = "x_WZZ_CMS_ttHt_btag_cErr1";
      else if(bTag_syst_names[i_b]=="CFErr2")
	h_name_WZZ = "x_WZZ_CMS_ttHt_btag_cErr2";

      TString h_name_ZZZ = "x_ZZZ_CMS_ttHt_btag_"+bTag_syst_names[i_b];
      if(bTag_syst_names[i_b]=="CFErr1")
	h_name_ZZZ = "x_ZZZ_CMS_ttHt_btag_cErr1";
      else if(bTag_syst_names[i_b]=="CFErr2")
	h_name_ZZZ = "x_ZZZ_CMS_ttHt_btag_cErr2";

      TString h_name_Rares = "x_Rares_CMS_ttHt_btag_"+bTag_syst_names[i_b];
      if(bTag_syst_names[i_b]=="CFErr1")
	h_name_Rares = "x_Rares_CMS_ttHt_btag_cErr1";
      else if(bTag_syst_names[i_b]=="CFErr2")
	h_name_Rares = "x_Rares_CMS_ttHt_btag_cErr2";
	...
	syst_name+=MC_sample_name_thu_unc[i_MC];
      ...
      TString cut = "PU_weight_MCSummer2016*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight";
    ...
    for(unsigned int i=0;i<thu_uncert.size();i++){
      ...
      TString h_name_ttZ = "x_ttZ_CMS_ttHt_thu_shape_ttZ_"+thu_uncert[i];
      TString h_name_ttG = "x_ttG_CMS_ttHt_thu_shape_ttG_"+thu_uncert[i];
      TString h_name_TTZ = "x_TTZ_CMS_ttHt_thu_shape_TTZ_"+thu_uncert[i];
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TString cut = "MC_weight*PU_weight_MCSummer2016*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight";
      cut+=Form("*(category==%i && isTrig_1l &&",cat[i_cat]) + MC_sample_cut[i_MC] + ")";
    ...
    for(unsigned int i=0;i<JES_TES_uncert.size();i++){
      ...
      TString h_name_WWW = "x_WWW_CMS_ttHt_"+JES_TES_uncert[i];
      TString h_name_WWZ = "x_WWZ_CMS_ttHt_"+JES_TES_uncert[i];
      TString h_name_WZZ = "x_WZZ_CMS_ttHt_"+JES_TES_uncert[i];
      TString h_name_ZZZ = "x_ZZZ_CMS_ttHt_"+JES_TES_uncert[i];
      TString h_name_Rares = "x_Rares_CMS_ttHt_"+JES_TES_uncert[i];
	...
	TString h_name = Form("x_TTZ_CMS_ttHt_templstat_1l_2tau_fakes_bin%i",i_bin);
...
void datacard_maker_mvis_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_12_2016/datacards/datacard_mvis_1l2tau_syst_12.9fb_122016.root";
