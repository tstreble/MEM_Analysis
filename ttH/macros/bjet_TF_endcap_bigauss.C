...
void plot_deltaE_nodRveto(){
  ...
  TString filename="bjet_bigauss_deltaE_endcap_nodRveto";
...
void plot_E_bin_nodRveto(bool low_E){
  ...
  TString filename="bjet_bigauss_Ebin_endcap_nodRveto";
  if(low_E)
    filename+="_low_E";
  else
    filename+="_high_E";
...
void plot_mean_sigma_jetTF(){
  ...
  TString filename0="frac_bjetTF_endcap_bigauss";
  ...
  TString filename="mean_bjetTF_endcap_bigauss";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
  ...
  TString filename2="sigma_bjetTF_endcap_bigauss";
  c2->SaveAs("../plots/pdf/"+filename2+".pdf");
  c2->SaveAs("../plots/png/"+filename2+".png");


  TFile* f_new = TFile::Open("bjetTF_endcap_bigauss_TTjets.root","RECREATE");
...
void plot_mean_sigma_jetTF_fixfrac(){
  ...
  TString filename="mean_bjetTF_endcap_bigauss_fixfrac";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
  ...
  TString filename2="sigma_bjetTF_endcap_bigauss_fixfrac";
  c2->SaveAs("../plots/pdf/"+filename2+".pdf");
  c2->SaveAs("../plots/png/"+filename2+".png");


  TFile* f_new = TFile::Open("bjetTF_endcap_bigauss_fixfrac_TTjets.root","RECREATE");
  frac_nodRveto->SetName("frac_nodRveto");
  frac_nodRveto->Write();
  mean1_nodRveto->SetName("mean1_nodRveto");
  mean1_nodRveto->Write();
...
void plot_mean_fit(){
  ...
  TFile* f = TFile::Open("bjetTF_endcap_bigauss_fixfrac_TTjets.root");
  ...
  TF1* new_TF_mean1=new TF1("mean_new1", "[0]+[1]*x",130,250);
  ...
  TF1* new_TF_mean2=new TF1("mean_new2", "[0]+[1]*x",130,250);
  ...
  TString filename="mean_bjetTF_endcap_bigauss_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_sigma_fit(){
  ...
  TF1* new_TF_sigma1=new TF1("sigma_new1", "TMath::Sqrt(([0]**2+([1]*TMath::Sqrt(x))**2)+([2]*x)**2)",130,250);
  ...
  TF1* new_TF_sigma2=new TF1("sigma_new2", "TMath::Sqrt(([0]**2+([1]*TMath::Sqrt(x))**2)+([2]*x)**2)",130,250);
  ...
  TString filename="sigma_bjetTF_endcap_bigauss_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
