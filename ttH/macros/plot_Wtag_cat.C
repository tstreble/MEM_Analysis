...
void plot_nPFJet30_untag_Wtag_cat_2CSVM(){
  ...
  TString filename="nPFJet30_untag_Wtag_cat_2CSVM_ttH";
...
void plot_nPFJet30_untag_Wtag_cat_1CSVM_1CSVL(){
  ...
  TString filename="nPFJet30_untag_Wtag_cat_1CSVM_1CSVL_ttH";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_2D_n_untag_nWtag_2lSS_2CSVM(){
  ...
  TH2F* h=single_plot2D("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","n_recoPFJet30_untag","n_pair_Wtag_recoPFJet30_untag","n_recolep==2&&recolep_charge[0]*recolep_charge[1]>0&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814",20,0,20,20,0,20);
  ...
  TString filename="2D_n_untag_nWtag_2lSS_2CSVM";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_2D_n_untag_nWtag_2lSS_1CSVM_1CSVL(){
  ...
  TString filename="2D_n_untag_nWtag_2lSS_1CSVM_1CSVL";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_2D_n_untag_nWtag_2lOS_2CSVM(){
  ...
  TString filename="2D_n_untag_nWtag_2lOS_2CSVM";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_2D_n_untag_nWtag_2lOS_1CSVM_1CSVL(){
  ...
  TString filename="2D_n_untag_nWtag_2lOS_1CSVM_1CSVL";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_btag_Wtag_cat(){
  ...
  TH1F* h_norm=(single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","n_recoPFJet30","n_recolep>1&&n_recotauh>0",15,0,15));

  vector<TH1F*> h;

  //Cat.1 - 2 CSVM
  TH1F* h_2lOS=single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","0","n_recolep==2&&recolep_charge[0]*recolep_charge[1]<0&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814 && n_pair_Wtag_recoPFJet30_untag>0",14,0,14);
  //Cat.1 - 1 CSVM + 1 CSVL
  h_2lOS->Add( single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","1","n_recolep==2&&recolep_charge[0]*recolep_charge[1]<0&&n_recotauh>0 &&  recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]<0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.423 && n_pair_Wtag_recoPFJet30_untag>0",14,0,14) );
  //Cat.2 - 2 CSVM
  h_2lOS->Add(single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","2","n_recolep==2&&recolep_charge[0]*recolep_charge[1]<0&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814 && n_pair_Wtag_recoPFJet30_untag==0 && n_recoPFJet30_untag>1",14,0,14));
  //Cat.2 - 1 CSVM + 1 CSVL
  ...
  //Cat.3 - 2 CSVM
  h_2lOS->Add(single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","4","n_recolep==2&&recolep_charge[0]*recolep_charge[1]<0&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814 && n_pair_Wtag_recoPFJet30_untag==0 && n_recoPFJet30_untag==1",14,0,14));
  //Cat.3 - 1 CSVM + 1 CSVL
  h_2lOS->Add( single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","5","n_recolep==2&&recolep_charge[0]*recolep_charge[1]<0&&n_recotauh>0 &&  recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]<0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.423 && n_pair_Wtag_recoPFJet30_untag==0 && n_recoPFJet30_untag==1",14,0,14) );



  //Cat.1 - 2 CSVM
  TH1F* h_2lSS=single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","6","n_recolep==2&&recolep_charge[0]*recolep_charge[1]>0&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814 && n_pair_Wtag_recoPFJet30_untag>0",14,0,14);
  //Cat.1 - 1 CSVM + 1 CSVL
  h_2lSS->Add( single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","7","n_recolep==2&&recolep_charge[0]*recolep_charge[1]>0&&n_recotauh>0 &&  recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]<0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.423 && n_pair_Wtag_recoPFJet30_untag>0",14,0,14) );
  //Cat.2 - 2 CSVM
  h_2lSS->Add(single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","8","n_recolep==2&&recolep_charge[0]*recolep_charge[1]>0&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814 && n_pair_Wtag_recoPFJet30_untag==0 && n_recoPFJet30_untag>1",14,0,14));
  //Cat.2 - 1 CSVM + 1 CSVL
  h_2lSS->Add( single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","9","n_recolep==2&&recolep_charge[0]*recolep_charge[1]>0&&n_recotauh>0 &&  recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]<0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.423 && n_pair_Wtag_recoPFJet30_untag==0 && n_recoPFJet30_untag>1",14,0,14) );
  //Cat.3 - 2 CSVM
  h_2lSS->Add(single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","10","n_recolep==2&&recolep_charge[0]*recolep_charge[1]>0&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814 && n_pair_Wtag_recoPFJet30_untag==0 && n_recoPFJet30_untag==1",14,0,14));
  //Cat.3 - 1 CSVM + 1 CSVL
  h_2lSS->Add( single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","11","n_recolep==2&&recolep_charge[0]*recolep_charge[1]>0&&n_recotauh>0 &&  recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]<0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.423 && n_pair_Wtag_recoPFJet30_untag==0 && n_recoPFJet30_untag==1",14,0,14) );



  //Cat.3l - 2 CSVM
  TH1F* h_3l=single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","12","n_recolep>2&&n_recotauh>0 && recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.814",14,0,14);
  //Cat.3l - 1 CSVM + 1 CSVL
  h_3l->Add( single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","13","n_recolep>2&&n_recotauh>0 &&  recoPFJet30_CSVsort_CSVscore[0]>0.814 && recoPFJet30_CSVsort_CSVscore[1]<0.814 && recoPFJet30_CSVsort_CSVscore[1]>0.423",14,0,14) );
  ...
  TString filename="btag_Wtag_cat_ttH";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
