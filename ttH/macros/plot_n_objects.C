...
void plot_n_lep(){
  ...
  h.push_back(single_plot("/data_CMS/cms/strebler/ttH_Samples/ntuples_converted/ntuple_ttH_nodRveto.root","HTauTauTree","n_recolep","",10,0,10));
