...
TString filename_ttH = "/data_CMS/cms/strebler/ttH_prod_80X_11_2016/ntuples_splitted/nominal/ttH/HTauTauTree_ttH_Hnonbb_split_bTagSF_CSVshape_trig1l.root";
TString filename_ttW = "/data_CMS/cms/strebler/ttH_prod_80X_11_2016/ntuples_splitted/nominal/ttV/HTauTauTree_ttW*_bTagSF_CSVshape_trig1l.root";
TString filename_ttZ = "/data_CMS/cms/strebler/ttH_prod_80X_11_2016/ntuples_splitted/nominal/ttV/HTauTauTree_ttZ_split_bTagSF_CSVshape_trig1l.root";
...
void initialize(){
  ...
  //filename_data.push_back(filename_SingleMu_2016BCD);
  //filename_data.push_back(filename_SingleEle_2016BCD);
  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC = single_plot(filename_MC[i_MC],
			       "HTauTauTree_1l_2tau",
			       var,
			       Form("MC_weight*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && isTrig_1l  && isGenMatched && n_recoPFJet>=4)",cat[i_cat]),
			       nbin,xmin,xmax);
    ...
    TH1F* h_ttH_fake = single_plot(filename_ttH,
				   "HTauTauTree_1l_2tau",
				   var,
				   Form("MC_weight*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && isTrig && !isGenMatched && n_recoPFJet>=4)",cat[i_cat]),
				   nbin,xmin,xmax);
    ...
    TH1F* h_ttH_tautau =single_plot(filename_ttH,
				    "HTauTauTree_1l_2tau",
				    var,
				    Form("MC_weight*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && genH_decayMode[1]<=5 && isTrig_1l && n_recoPFJet>=4)",cat[i_cat]),
				    nbin,xmin,xmax);
    ...
    TH1F* h_ttH_WW =single_plot(filename_ttH,
				"HTauTauTree_1l_2tau",
				var,
				Form("MC_weight*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && genH_decayMode[1]>5 && n_genW==4 && isTrig_1l && n_recoPFJet>=4)",cat[i_cat]),
				nbin,xmin,xmax);
    ...
    TH1F* h_ttH_ZZ =single_plot(filename_ttH,
				"HTauTauTree_1l_2tau",
				var,
				Form("MC_weight*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && genH_decayMode[1]>5 && n_genZ==2 && isTrig_1l && n_recoPFJet>=4)",cat[i_cat]),
				nbin,xmin,xmax);
    ...
    TH1F* h_fakes =single_plot(filename_data,
			       ...
			       var,
			       Form("event_weight_ttH*(category==%i && isTrig_1l && n_recoPFJet>=4)",cat_fakes[i_cat]),
			       nbin,xmin,xmax);
    ...
    /*TH1F* h_data_obs =single_plot(filename_data,
      "HTauTauTree_1l_2tau",
      var,
      Form("(category==%i && isTrig_1l && n_recoPFJet>=4)",cat[i]),		
      nbin,xmin,xmax);
	...
	TString cut = "MC_weight*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight_" + bTag_syst_names[i_b];
	if(MC_sample_name[i_MC]!="ttH")
	  cut+=Form("*(category==%i && isTrig && isGenMatched && n_recoPFJet>=4)",cat[i_cat]);
	else
	  cut+=Form("*(category==%i && isTrig && n_recoPFJet>=4)",cat[i_cat]);
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name_thu_unc.size();i_MC++){
      ...
      TH1F* h_MC_x1_up = single_plot(filename_MC_thu_unc[i_MC],
				     "HTauTauTree_1l_2tau",
				     var,
				     Form("MC_weight_scale_muF2*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && isTrig_1l && n_recoPFJet>=4)",cat[i_cat]),
				     nbin,xmin,xmax);
      ...
      TH1F* h_MC_x1_down = single_plot(filename_MC_thu_unc[i_MC],
				       "HTauTauTree_1l_2tau",
				       var,
				       Form("MC_weight_scale_muF0p5*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && isTrig_1l && n_recoPFJet>=4)",cat[i_cat]),
				       nbin,xmin,xmax);
      ...
      TH1F* h_MC_y1_up = single_plot(filename_MC_thu_unc[i_MC],
				     "HTauTauTree_1l_2tau",
				     var,
				     Form("MC_weight_scale_muR2*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && isTrig_1l && n_recoPFJet>=4)",cat[i_cat]),
				     nbin,xmin,xmax);
      ...
      TH1F* h_MC_y1_down = single_plot(filename_MC_thu_unc[i_MC],
				       "HTauTauTree_1l_2tau",
				       var,
				       Form("MC_weight_scale_muR0p5*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && isTrig_1l && n_recoPFJet>=4)",cat[i_cat]),
				       nbin,xmin,xmax);
    ...
    /*for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TString cut = Form("MC_weight*PU_weight*triggerSF_weight_v2*leptonSF_ttH_weight_v2*bTagSF_CSVshape_weight*(category==%i && isTrig_1l)",cat[i_cat])
...
void datacard_maker_njet_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/strebler/ttH_prod_80X_11_2016/datacards/datacard_njet_1l2tau_syst_4jet_12.9fb_112016.root";
