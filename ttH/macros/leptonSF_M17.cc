...
float _get_recoToLoose_leptonSF_ttH(int pdgid, float pt, float eta, int nlep, float var=0){
  ...
  if (!_histo_recoToLoose_leptonSF_mu1) {
    _file_recoToLoose_leptonSF_mu1 = new TFile("lepSF/TnP_NUM_LooseID_DENOM_generalTracks_VAR_map_pt_eta.root","read");
    _file_recoToLoose_leptonSF_mu2 = new TFile("lepSF/TnP_NUM_MiniIsoLoose_DENOM_LooseID_VAR_map_pt_eta.root","read");
    _file_recoToLoose_leptonSF_mu3 = new TFile("lepSF/TnP_NUM_TightIP2D_DENOM_MediumID_VAR_map_pt_eta.root","read");
    _file_recoToLoose_leptonSF_mu4 = new TFile("lepSF/ratios_HIP_trkEff.root","read");
...
float _get_looseToTight_leptonSF_ttH(int pdgid, float pt, float eta, int nlep, float var){
  ...
  if (!_histo_looseToTight_leptonSF_mu_2lss) {
    _file_looseToTight_leptonSF_mu_2lss = new TFile("lepSF/lepMVAEffSF_m_2lss_M17.root","read");
  ...
  if (!_histo_looseToTight_leptonSF_el_2lss) {
    _file_looseToTight_leptonSF_el_2lss = new TFile("lepSF/lepMVAEffSF_e_2lss_M17.root","read");
  ...
  if (!_histo_looseToTight_leptonSF_mu_3l) {
    _file_looseToTight_leptonSF_mu_3l = new TFile("lepSF/lepMVAEffSF_m_3l_M17.root","read");
    _histo_looseToTight_leptonSF_mu_3l = (TH2F*)(_file_looseToTight_leptonSF_mu_3l->Get("sf"));
  }
  if (!_histo_looseToTight_leptonSF_el_3l) {
    _file_looseToTight_leptonSF_el_3l = new TFile("lepSF/lepMVAEffSF_e_3l_M17.root","read");
