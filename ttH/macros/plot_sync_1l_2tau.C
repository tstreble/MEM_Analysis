...
void plot_pT_lep_LLR_ND(){

  vector<TH1F*> h;
  h.push_back(single_plot("/afs/cern.ch/work/t/tstreble/public/syncNtuple_ttH_Htautau/syncNtuple_event_ttH_80X.root","syncTree_1l2tau_SR","max(ele0_pt,mu0_pt)","MC_weight*bTagSF_weight*leptonSF_weight*triggerSF_weight",50,0.,250));
  h.push_back(single_plot("/afs/cern.ch/user/m/matze/public/ttH/80X/sync_ntuple.root","syncTree_1l2tau_SR","max(ele0_pt,mu0_pt)","MC_weight*bTagSF_weight*leptonSF_weight*triggerSF_weight",50,0.,250));


  vector<TString> leg_entry;
  leg_entry.push_back("LLR");
  leg_entry.push_back("ND");
  ...
  for(unsigned int i=0;i<h.size();i++){
    ...
    h[i]->GetXaxis()->SetTitle("Lepton p_{T} [GeV]");
  ...
  h_ratio->GetYaxis()->SetTitle("ND/LLR");
  ...
  TString plotname="Lep_pT_sync_1l2tau_LLR_ND";
...
void plot_pT_lead_jet_fake_LLR_ND(){

  vector<TH1F*> h;
  h.push_back(single_plot("/afs/cern.ch/work/t/tstreble/public/syncNtuple_ttH_Htautau/syncNtuple_event_ttH_80X.root","syncTree_1l2tau_Fake","jet0_pt","MC_weight*bTagSF_weight*triggerSF_weight*FR_weight",50,0.,250));
  h.push_back(single_plot("/afs/cern.ch/user/m/matze/public/ttH/80X/sync_ntuple.root","syncTree_1l2tau_Fake","jet0_pt","MC_weight*bTagSF_weight*triggerSF_weight*FR_weight",50,0.,250));
