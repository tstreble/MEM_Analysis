...
void test_1l2tau_Xtrig(){
  ...
  TString filein="/data_CMS/cms/strebler/ttH_prod_80X_01_2017/ntuples_splitted/nominal/ttH/syncNtuple_ttH_tautau_prod012017_split_BDT_1l2tau_btagSF_new.root";
  TString fileout="test.root";

  vector<TString> treename;
  treename.push_back("HTauTauTree_1l_2tau");
  
  add_trigger_filter_1l2tau_Xtrig(filein,fileout,treename,true);  
