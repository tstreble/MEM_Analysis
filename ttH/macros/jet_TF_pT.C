...
void plot_mean_sigma_jetTF(){
  ...
  TString filename="mean_jetTF_pT";
  ...
  TString filename2="sigma_jetTF_pT";
  c2->SaveAs("../plots/pdf/"+filename2+".pdf");
  c2->SaveAs("../plots/png/"+filename2+".png");


  TFile* f_new = TFile::Open("jetTF_pT_TTjets.root","RECREATE");
...
void plot_mean_fit(){
  ...
  TFile* f = TFile::Open("jetTF_pT_TTjets.root");
  ...
  TString filename="mean_jetTF_pT_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
...
void plot_sigma_fit(){
  ...
  TString filename="sigma_jetTF_pT_fit";
  c->SaveAs("../plots/pdf/"+filename+".pdf");
  c->SaveAs("../plots/png/"+filename+".png");
